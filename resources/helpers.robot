...
${START}    COMEÇAR
${MENU_HAMBURGER}    xpath=//android.widget.ImageButton[@content-desc="Open navigation drawer"]
...
Open Nav
    ...
    Wait Until Element Is Visible   ${MENU_HAMBURGER}

    Click Element                    ${MENU_HAMBURGER}
